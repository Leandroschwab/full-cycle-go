...
type QueryResolver interface {
	ListOrders(ctx context.Context) (*model.ListOrdersResponse, error)
}
...
func (ec *executionContext) _Query_listOrders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOlistOrdersResponse2ᚖgithubᚗcomᚋdevfullcycleᚋ20ᚑCleanArchᚋinternalᚋinfraᚋgraphᚋmodelᚐListOrdersResponse(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOlistOrdersResponse2ᚖgithubᚗcomᚋdevfullcycleᚋ20ᚑCleanArchᚋinternalᚋinfraᚋgraphᚋmodelᚐListOrdersResponse(ctx context.Context, sel ast.SelectionSet, v *model.ListOrdersResponse) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
